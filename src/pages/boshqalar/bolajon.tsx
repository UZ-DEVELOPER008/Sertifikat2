...
const Bolajon = () => {
    return(
        ...
        <img className="yana-img-4" src="https://beeline.uz/wp-content/uploads/2023/03/detskij-uz-1440x408-1.jpg" alt="" />
    </div>

    <div className="birga">
        <div className="tafsilot">
            <h1 className="tafsilot-title">Tarif tafsilotlari</h1>
            <p className="tafsilot-title">Tarmoq ichidagi qo'ng'iroqlar <span className="limit10"><b>500</b>daq/oy</span> </p> 
